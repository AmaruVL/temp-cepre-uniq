  ...
  return (
    <div className="">
      <div className="">
        ...
        >
          Reporte de Cantidad de Preinscripciones y detalle por Carrera
        </Typography>
      </div>
      <FormularioFechas
        ...
        escuelasProfesionales={props.escuelasProfesionales}
      />
      {/* <ModalPieChart dataEstudiante={props.dataEstudiante} /> */}
    </div>
  );
}
