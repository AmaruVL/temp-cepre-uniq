...
import ModalDetallesExamenes from './modalDetallesExamenes';
        ...
        <Table stickyHeader aria-label="sticky table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">FECHA DE EXAMEN</TableCell>
              <TableCell align="center">TIPO DE EXAMEN</TableCell>
              ...
              dataEstudiante
                ...
                .map((value, index) => (
                  <TableRow key={index} hover>
                    ...
                    <TableCell align="center">{value.id_examen.fecha_examen}</TableCell>
                    <TableCell align="center">{value.id_examen.tipo_examen}</TableCell>
                    <TableCell align="center">
                      <ModalDetallesExamenes value={value} />
                    </TableCell>
                  </TableRow>
                ))}
          </TableBody>
