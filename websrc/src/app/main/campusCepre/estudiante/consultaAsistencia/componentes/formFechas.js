...
const FormularioFechas = (props) => {
  ...
  function onSubmit(dataForm) {
    ...
    // setIsLoading(true);
    // const fechaInicioDetalle = dataForm.fechaInicio.split('-');
    // const fechaFinDetalle = dataForm.fechaFin.split('-');
    // const fechaInicioPost = `${fechaInicioDetalle[2]},${fechaInicioDetalle[1]},${fechaInicioDetalle[0]}`;
    // const fechaFinPost = `${fechaFinDetalle[2]},${fechaFinDetalle[1]},${fechaFinDetalle[0]}`;
    // setFechaIn(fechaInicioPost);
    // setFechaFin(fechaFinPost);
    axios
      .post(`${RutaGeneral}/docente/asistencia/consulta-asistencia-fechas/${dataForm.estudiante}`, {
        f_inicio: dataForm.fechaInicio,
        f_fin: dataForm.fechaFin,
        id_horario: dataForm.cursos,
      })
      .then((res) => {
        setIsLoading(false);
