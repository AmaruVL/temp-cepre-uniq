...
const dataUsuario = sessionStorage.getItem('dataUsuario');
const imagenUsuario = sessionStorage.getItem('imagenUsuario');
const userData = JSON.parse(dataUsuario);
const nombre = userData !== null ? userData.nombres : '';
const email = userData !== null ? userData.correo : '';
const initialState = {
  role: [], // guest
  data: {
    displayName: nombre,
    photoURL: imagenUsuario,
    email,
