...
class serializer_user(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id','username','email', 'first_name', 'last_name', 'sur_name', 'password','user_type']
...
class serializer_aula(serializers.ModelSerializer):
    class Meta:
        model = aula
        fields = '__all__'
class serializer_aula_mostrar(serializers.ModelSerializer):
    id_pabellon = serializer_pabellon()
    class Meta:
        model = aula
        fields = '__all__'
...
class serializer_administrador(serializers.ModelSerializer):
    class Meta:
        model = administrador
        fields = '__all__'
class serializer_administrador_mostrar(serializers.ModelSerializer):
    user_type = serializer_user()
    class Meta:
        model = administrador
        fields = '__all__'
...
class serializer_escuela_prof_mostrar(serializers.ModelSerializer):
...
class serializer_examen_mostrar(serializers.ModelSerializer):
    #hora_inicio = serializers.TimeField(format='%I:%M %p', input_formats='%I:%M %p')
    #hora_fin = serializers.TimeField(format='%I:%M %p', input_formats='%I:%M %p')
    class Meta:
        model = examen
...
class serializer_examen_grupo_mostrar(serializers.ModelSerializer):
    id_examen = serializer_examen()
    id_grupo_academico = serializer_grupo_academico()
    class Meta:
        model = examen_grupo
...
class serializer_preguntas_examen_grupo_mostrar(serializers.ModelSerializer):
    id_balota_curso = serializer_balota_preguntas_curso()
    class Meta:
        model = preguntas_examen_grupo
        fields = '__all__'

class serializer_examenCiclo(serializers.ModelSerializer):
    class Meta:
        model = examenCiclo
        fields = '__all__'
    
class serializer_examenCiclo_mostrar(serializers.ModelSerializer):
    id_examen = serializer_examen()
...
class serializer_docente_mostrar(serializers.ModelSerializer):
    user_type = serializer_user()
    # id_curso = serializer_padron_curso()
    class Meta:
        model = docente
        fields = '__all__'
        

class serializer_docente_curso(serializers.ModelSerializer):
    class Meta:
        model = docente_curso
        fields = '__all__'


class serializer_docente_curso_mostrar(serializers.ModelSerializer):
...
class serializer_docente_curso_mostrar_solo_curso(serializers.ModelSerializer):
    #id_docente = serializer_docente_mostrar()
    id_curso = serializer_padron_curso()
    class Meta:
        model = docente_curso
...
class serializer_comentario_clase_docente_mostrar(serializers.ModelSerializer):
    id_horario = serializer_horario_mostrar()    
    id_estudiante = serializer_estudiante_most()
    id_docente = serializer_docente_mostrar()
    class Meta:
        model = comentarios_clase
        #fields = '__all__'
...
class serializer_comentario_clase_estudiante_mostrar(serializers.ModelSerializer):
    id_horario = serializer_horario_mostrar()
    id_docente = serializer_docente_mostrar()
    id_estudiante = serializer_estudiante_most()
    class Meta:
...
class serializer_balota_preguntas_curso_show(serializers.ModelSerializer):
    id_padron_curso_grupo = serializer_padron_curso_grupo_mostrar()
    class Meta:
        model = balota_preguntas_curso
        fields = '__all__'

class serializer_preguntas_examen_grupo_mostrar_todo(serializers.ModelSerializer):
    id_balota_curso = serializer_balota_preguntas_curso_show()
    class Meta:
        model = preguntas_examen_grupo
        fields = '__all__'


class serializer_resultados_examen_estudiante(serializers.ModelSerializer):
    class Meta:
        model = resultados_examen_estudiante
        fields = '__all__'


class serializer_estudiante_examen_det(serializers.ModelSerializer):
    id_estudiante = serializer_estudiante()
    class Meta:
        model = examen_estudiante
        fields = '__all__'
